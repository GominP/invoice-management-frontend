...
export default function LandingPage() {
    ...
    return ( <
        ...
        xs = { 12 } >
        <
        NavigateCard headText = { role === "biller" ? "PAYERS" : "CREDITOR" }
        detail = {
            role === "biller" ?
            "Check detail about payers." : "Check detail about creditors."
        }
        ...
        xs = { 12 } >
        <
        NavigateCard headText = "INVOICES"
        ...
        lg = { 12 } >
        <
        CardTotal2 text = { rowTotalText[1] }
        ...
        lg = { 12 } >
        <
        CardTotal3 text = { rowTotalText[2] }
        amount = { allTotal[2] } > < /CardTotal3> < /
        Grid > <
        /Grid> < /
        Grid > <
        Grid item xs = { 12 } > { /* <NavigateCard headText="PAYMENTS" detail="" img={paymentIcon} /> */ } <
        /Grid> < /
        Grid > <
        /Grid> < /
        Grid > <
